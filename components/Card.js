  ...
  >
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="mb-3 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
          {date}
        </p>
